...
class LuongAttnDecoderRNN(nn.Module):
    ...
    def forward(self, input_step, last_hidden, encoder_outputs):
        ...
        rnn_output, hidden = self.gru(rnn_output, encoder_outputs)
        attn_weights = self.attn(rnn.output, encoder_outputs)
...
def train(input_variable, lengths, target_variable, mask, max_target_len, encoder, decoder, embedding,
    ...
    encoder_ouptuts, encoder_hidden = encoder(input_variable, lengths)
    ...
    if use_teacher_forcing:
        for t in range(max_target_len):
            decoder_output, decoder_hidden = decoder(
                decoder_output, decoder_hidden, encoder_outputs)
